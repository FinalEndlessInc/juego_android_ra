...
fun ParaLaSolicitudDePermisos(
    ...
    LaunchedEffect(key1 = estado_de_los_permisos) {
        ...
        /*val lista_de_permisos_por_pedir = estado_de_los_permisos.permissions.fastFilter {
            !it.status.isGranted
        ...
        val lista_de_permisos_por_pedir = estado_de_los_permisos.permissions.fastFilter { permisos ->
            !permisos.status.isGranted
        }
